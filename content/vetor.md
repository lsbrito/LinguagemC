...
⚠️ Importante:
O scanf("%s", nome); não captura espaços. Se o usuário digitar Leandro Brito, apenas Leandro será armazenado. Neste caso com o SCANF será necessário captura da  seguinte forma Leandro-Brito ou leandro_Brito.
